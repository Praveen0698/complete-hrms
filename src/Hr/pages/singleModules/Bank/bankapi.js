...
export const saveAddbank = async (formData) => {
    try{
        await axios.post(
            "http://13.200.246.216:5000/addbank/create/addbank",
            formData
          );
    } catch(error) {
...
export const deleteBank = async (id) => {
    try{
        await axios.delete(`http://13.200.246.216:5000/addbank/delete/${id}`)
    } catch(error) {
...
export const loadAddbank = async () => {
    try {
       const result =  await axios.get(
            "http://13.200.246.216:5000/addbank/get/addbank",
            {
              validateStatus: () => {
                return true;
              },
